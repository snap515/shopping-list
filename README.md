...
SL-29 на экранах ввода лоигна и пароля после enter - переходить на следующий инпут, а после повторного ентера - логинить или регистрирвать
SL-30 добавить обработку ентера для всех инпутов
