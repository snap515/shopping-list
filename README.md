...
SL-68 Блокировать кнопки во время запроса (invite/create/accept и т.п.) [DONE]
...
this has been done after version 1.0.0:
SL-72 починить удаление списка для веб [DONE]
SL-73 добавить уведомление если список, в котором находится юзер был удалён и перенаправить его на страницу списков [DONE]
