...
SL-31 исправить баг при смене темы - возвращает на Lists(только на мобильной версии?), при смене языка так же кидает на Lists
SL-32 [missing "en.invites.accept.error" translation] - ошибка при принятии приглашения. Добавить переводы при ошибке
